...
public class ModuleButton implements MinecraftInterface {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        context.fill(parent.x, parent.y + offset, parent.x + parent.width, parent.y + offset + parent.height, module.isEnabled() ? new Color(60,60,60,200).getRGB() : new Color(20, 20, 20, 200).getRGB());
        ...
        if (module.isEnabled()) context.fill(parent.x, parent.y + offset,parent.x + 1, parent.y + offset + parent.height, new Color(0, 190, 255).getRGB());
